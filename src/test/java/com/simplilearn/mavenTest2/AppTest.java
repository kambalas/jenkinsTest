...
public class AppTest 
{
    ...
    public void test1(String fileName) throws IOException, InterruptedException {
...
//            driver.findElement(By.id("BillingNewAddress_PhoneNumber")).sendKeys("A");
        ...
        {
        	test1("C:\\Users\\PC\\eclipse-workspace\\testMaven\\src\\main\\java\\com\\simplilearn\\mavenTest2\\data1.txt");
        }
        }
